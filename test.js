...
var textColor = getContrastingTextColor(themeColor);
...
var isCtaOpenByDefaultMobile = true;
...
var isCtaOpenByDefaultDesktop = true;
...
const onboardingTier1 = `https://main.dp9ch69srufqq.amplifyapp.com/?formName=${formName}&clinicSdkKey=${clinicSdkKey}&themeColor=${encodeURIComponent(
  themeColor,
)}&referrer=${document.referrer}&visitorId=${generateUUID()}#Areas_of_Interest`;
// END OF FORM URL /////////////////////////////////////////////////////////////
